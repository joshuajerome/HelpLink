...
struct LockScreenWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = LockScreenWidgetAttributes(name: "Me")
    static let contentState = LockScreenWidgetAttributes.ContentState(value: 3)
